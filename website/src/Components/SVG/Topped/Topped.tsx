...
import { ToppedProps } from "./_types"

const Topped: FC<ToppedProps> = (props) => {
    const { className, topped, width = 34, height = 34, ...otherProps } = props
        ...
        >
            ...
            <g fill="none" fillRule="evenodd">
                <path
                    ...
                    fill={topped ? "rgb(255, 68, 0)" : "rgb(47, 47, 46) "}
                />
                <path
                    ...
                    fill={topped ? "rgb(255, 208, 0)" : "rgb(104, 104, 104) "}
                />
            </g>
        </svg>
    )
