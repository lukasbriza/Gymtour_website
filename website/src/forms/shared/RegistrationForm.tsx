...
import { useModal, useServerdataLazy } from "src/hooks"
import { addUser } from "src/fetcher"
import { Checkbox, ErrorModalHeader, ModalHeader, StringInput } from "src/components"
import { registrationFormValidation } from "src/validations"
...
export const RegistrationForm: FC<RegistrationFormProps> = (props) => {
    ...
    const { register, handleSubmit, reset, formState: { errors } } = useForm<RegisterFormValues>({
        ...
        resolver: registrationFormValidation(t)
    })
